...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_PATH, 'goheels.db'), # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'goheels.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'goheels.wsgi.application'
